      ...
      <Formik
        ...
        onSubmit={(values, actions) => {
          ...
          if (!userObj) {
            ...
            const localUpwd = (userObj && base64.decode(userObj.password)) || null;

            if (values.userName === localUname && values.password === localUpwd) {
          ...
          <div className="container mt-2 mb-4 divMiddle">
            <div className="col-sm-8 ml-auto mr-auto">
              ...
              >
                ...
                >
                  <div className="col-sm-12 border shadow rounded pt-2">
